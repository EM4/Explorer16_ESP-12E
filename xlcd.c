...
/*This par of the code is initialization by instruction*/
    ...
    XLCD_DATAPORT_TRIS  &= 0xFF00;             //make DATAPORT output
    XLCD_DATAPORT &= 0xFF00;
#endif                       
...
//initialization by instruction
    ...
    XLCD_DATAPORT |= 0x0030;        // Function set cmd(8-bit interface)
#endif    
...
#ifdef XLCD_8BIT                    // 8-bit mode interface
    XLCD_DATAPORT |= 0x00300;       // Function set cmd(8-bit interface)
#endif    
...
void XLCDPutRomString(const char *string)
{
